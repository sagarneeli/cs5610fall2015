...
app.controller('TweetHud', function($scope, $resource, $timeout, $rootScope, $timeout, PubNub, UserService) {
  ...
  var pubnubConfig = {
    subscribe_key: "sub-c-5d445c1a-a114-11e5-b0f3-02ee2ddab7fe",
    channel: "tweet_stream"
  };

  $scope.trendsResource = $resource('/stream');

  //UserService.findPubnub()
  //  .then(function (pubnub) {
  //    pubnubConfig = pubnub;
